  ...
  return (
    <section id="tickets" style={{
      ...
      <div style={{display:"flex",flexDirection:"column",gap:"10px"}}>
            ...
            <a href="https://www.eventbrite.com/e/taste-of-art-tickets-1982512459133" target="_blank" rel="noopener noreferrer" style={{
              display:"flex", justifyContent:"space-between", alignItems:"center",
            ...
            onMouseLeave={(e:any)=>{e.currentTarget.style.background="rgba(255,255,255,0.04)";e.currentTarget.style.transform="translateX(0)"}}>
              <div>
                <div style={{fontSize:"14px",fontWeight:700,color:"#fff"}}>April</div>
            ...
            <a href="https://www.eventbrite.com/e/taste-of-art-tickets-1982512754015" target="_blank" rel="noopener noreferrer" style={{
              display:"flex", justifyContent:"space-between", alignItems:"center",
              padding:"16px 20px", borderRadius:"14px",
              background:"rgba(255,255,255,0.04)", border:"1px solid rgba(255,255,255,0.08)",
              textDecoration:"none", color:"inherit",
            ...
            <a href="https://www.eventbrite.com/e/taste-of-art-tickets-1982513123119" target="_blank" rel="noopener noreferrer" style={{
              display:"flex", justifyContent:"space-between", alignItems:"center",
              padding:"16px 20px", borderRadius:"14px",
              background:"rgba(255,255,255,0.04)", border:"1px solid rgba(255,255,255,0.08)",
              textDecoration:"none", color:"inherit",
            ...
            <a href="https://www.eventbrite.com/e/taste-of-art-tickets-1982513445082" target="_blank" rel="noopener noreferrer" style={{
              display:"flex", justifyContent:"space-between", alignItems:"center",
              padding:"16px 20px", borderRadius:"14px",
              background:"rgba(255,255,255,0.04)", border:"1px solid rgba(255,255,255,0.08)",
              textDecoration:"none", color:"inherit",
            ...
            <a href="https://www.eventbrite.com/e/taste-of-art-tickets-1982514621601" target="_blank" rel="noopener noreferrer" style={{
              display:"flex", justifyContent:"space-between", alignItems:"center",
              padding:"16px 20px", borderRadius:"14px",
              background:"rgba(255,255,255,0.04)", border:"1px solid rgba(255,255,255,0.08)",
              textDecoration:"none", color:"inherit",
            ...
            <a href="https://www.eventbrite.com/e/taste-of-art-tickets-1982515491202" target="_blank" rel="noopener noreferrer" style={{
              display:"flex", justifyContent:"space-between", alignItems:"center",
              padding:"16px 20px", borderRadius:"14px",
              background:"rgba(255,255,255,0.04)", border:"1px solid rgba(255,255,255,0.08)",
              textDecoration:"none", color:"inherit",
            ...
            onMouseLeave={(e:any)=>{e.currentTarget.style.background="rgba(255,255,255,0.04)";e.currentTarget.style.transform="translateX(0)"}}>
              <div>
                <div style={{fontSize:"14px",fontWeight:700,color:"#fff"}}>December</div>
                <div style={{fontSize:"11px",color:"rgba(255,255,255,0.4)",marginTop:"2px"}}>Eventbrite · Tickets Available</div>
              </div>
              <div style={{padding:"8px 16px",borderRadius:"10px",background:"linear-gradient(135deg,#FF6B35,#FFB347)",color:"#000",fontSize:"11px",fontWeight:800,letterSpacing:"0.04em"}}>GET TICKETS</div>
            </a>
